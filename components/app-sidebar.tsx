          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? "border-l-primary bg-primary/15 text-white shadow-[0_0_16px_0_oklch(0.75_0.19_55_/_25%)]"
                  : "border-l-transparent text-sidebar-foreground/70 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground"
              )}
            >
