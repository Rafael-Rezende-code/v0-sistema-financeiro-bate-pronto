            ...
            <CardContent className="space-y-4 md:space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select value={channel} onValueChange={(v) => setChannel(v as SaleChannel)}>
                  ...
                  <SelectContent>
                    {(Object.keys(CHANNEL_LABELS) as SaleChannel[]).map((key) => (
                      <SelectItem key={key} value={key}>{CHANNEL_LABELS[key]}</SelectItem>
                    ))}
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="team" className="text-sm">Time (opcional)</Label>
                <Input
                  id="team"
              ...
              <div className="space-y-2">
                ...
                <Select value={size} onValueChange={(v) => setSize(v as SaleSize)}>
                  <SelectTrigger className="h-10 md:h-11">
              ...
              <div className="space-y-2">
                ...
                <Select value={saleType} onValueChange={(v) => setSaleType(v as SaleType)}>
                  ...
                  <SelectContent>
                    {(Object.keys(SALE_TYPE_LABELS) as SaleType[]).map((key) => (
                      <SelectItem key={key} value={key}>{SALE_TYPE_LABELS[key]}</SelectItem>
                    ))}
                  </SelectContent>
                </Select>
              </div>
