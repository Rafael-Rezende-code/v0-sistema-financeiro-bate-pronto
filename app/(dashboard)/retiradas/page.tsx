  ...
  return (
    <div className="p-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Retiradas dos Sócios</h1>
          <p className="text-muted-foreground">
            Gerencie as retiradas de Rafael e João
          </p>
        </div>
              ...
              <CardHeader>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <CardDescription>50% do lucro líquido</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="rounded-lg border p-4">
                      <p className="text-sm text-muted-foreground">Parte do Lucro (50%)</p>
                      <p className="text-xl font-bold">{formatCurrency(lucro50)}</p>
                    </div>
                    <div className="rounded-lg border p-4">
                      <p className="text-sm text-muted-foreground">Já Retirado</p>
                      <p className="text-xl font-bold text-orange-600">{formatCurrency(totalRetirado)}</p>
                    </div>
                  </div>
